...
The `appraiserres-x64.dll` file hosted on this GitHub is now down. W11ISPatcher version 1 will now require [a local `appraiserres.dll` file](#using-a-local-appraiserresdll-file).
